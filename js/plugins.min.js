...
!function(t){t.tabbed=function(a){var s=this;s.init=function(){var e,i,n,b=[],d=t(".tab_button"),c=d.length,o="";s.options=t.extend({},t.tabbed.defaultOptions,a);for(var h=0;c>h;h++){e=d[h],i=t(e).next()[0],n=t(i).next()[0],b.push(e,i);do{if(n=t(i).next()[0],i=t(n).next()[0],t(n).hasClass("tab_button")!==!0)break;b.push(n,i)}while(t(n).hasClass("tab_button")===!0);t(e).data("tabbed")!==!0&&(void 0!==t(e).attr("data-tab")&&(o=t(e).attr("data-tab")),t(b).data("tabbed",!0).wrapAll("<section class = 'tabbed "+o+"' />")),b.length=0,o=""}var l=t(".tabbed");t(l).each(function(){t(this).children(".tab_content").length>1&&t(this).prepend("<nav class='tabs' />")}),t(".tab_button").each(function(){var a=t(this).closest(".tabbed").children(".tabs");t(this).clone().appendTo(a).addClass("tab").removeClass("tab_button")}),t(".tabbed .tab_button:first-of-type, .tabbed .tab:first-child").addClass("active"),t(".tab_content").hide();var r=""+t(".active").map(function(){return t(this).attr("href")}).get();t(r).each(function(){t(this).show()}),t(".tab_content").each(function(){var a=t(this).closest(".tabbed").find(".tabs:first").outerHeight(),s=parseInt(t("body").css("line-height"),10);a=Math.ceil(a/s)*s-1,t(this).css("min-height",a)}),t(".tabs .tab").click(function(a){t(this).hasClass("active")===!1&&(r=t(this).attr("href"),t(this).closest(".tabbed").find(".tab_content:first").siblings(".tab_content").addBack().hide(),t(r).fadeIn(s.options.speed),t(this).closest(".tabbed").find(".tab:first, .tab_button:first").siblings(".tab,.tab_button").addBack().removeClass("active"),t(this).addClass("active"),t(".tab_button[href^='"+r+"']").addClass("active")),a.preventDefault()}),t(".tab_button").click(function(a){t(this).hasClass("active")===!1&&(r=t(this).attr("href"),t(this).closest(".tabbed").find(".tab_content:first").siblings(".tab_content").addBack().slideUp("fast"),t(r).css("min-height","0").slideToggle(s.options.speed),t(this).closest(".tabbed").find(".tab:first, .tab_button:first").siblings(".tab, .tab_button").addBack().removeClass("active"),t(this).addClass("active"),t(this).closest(".tabbed").find(".tab[href^='"+r+"']").addClass("active")),a.preventDefault()})},s.init()},t.tabbed.defaultOptions={speed:300},t.fn.tabbed=function(a){return this.each(function(){new t.tabbed(a)})}}(jQuery);
!function(t){for(var n,i=t("table"),e=[],h=0;h<i.length;h++){var r=t(i)[h];n=t(r).find("th").map(function(){t(this).each(function(){return this.innerText})}),e.push(n.prevObject),e=e[0],t(r).find("tr").each(function(){t(this).find("td").each(function(n){t(this).attr("data-th",e[n].innerText)})})}}(jQuery);
