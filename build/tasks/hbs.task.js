/**
 * !!NOTE!!
 * This task is deprecated and should only be used if completely necessary.
 * Handlebars should be used through webpack instead of gulp,
 * since it handles dynamic partials without a ton of work.
 *
 * If you must use this file, make sure to add install the missing dependecies:
 * npm install gulp-handlebars gulp-htmlmin gulp-rename --save-dev
 *
...
const BUILD_NUMBER = require('../helpers/build-number.js');
