...
/*!**********************************************************************************!*\
  !*** C:/Users/cdl193/Sites/Front-End-Framework/_src/_samples/svelte.sample.html ***!
  \**********************************************************************************/
...
/* harmony import */ var _components_base_base_sv_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/base/base.sv.html */ "../../_src/components/base/base.sv.html");
/* harmony import */ var _components_button_button_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/button/button.html */ "../../_src/components/button/button.html");
/* harmony import */ var svelte_store_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! svelte/store.js */ "../../node_modules/svelte/store.js");
...
Svelte_sample.filename = "C:\\Users\\cdl193\\Sites\\Front-End-Framework\\_src\\_samples\\svelte.sample.html";
...
${_components_base_base_sv_html__WEBPACK_IMPORTED_MODULE_0__["default"]._render(__result, {}, { store: options.store, slotted: { default: () => `
    ${_components_button_button_html__WEBPACK_IMPORTED_MODULE_1__["default"]._render(__result, {type: state.buttonType, body: "Other Stuff"}, { store: options.store })}
    ${_components_button_button_html__WEBPACK_IMPORTED_MODULE_1__["default"]._render(__result, {type: false}, { store: options.store })}
` } })}`;
};
...
Svelte_sample.renderCss = function() {
	...
	addComponent(_components_button_button_html__WEBPACK_IMPORTED_MODULE_1__["default"]);
	addComponent(_components_base_base_sv_html__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/* harmony default export */ __webpack_exports__["default"] = (Svelte_sample);
...
Button._render = function(__result, state, options) {
	...
	return `<button class="btn ${__escape(_tools_modifiers_js__WEBPACK_IMPORTED_MODULE_0___default()(state.type, 'btn--'))}">
    <span class="btn__body ${__escape(_tools_modifiers_js__WEBPACK_IMPORTED_MODULE_0___default()(state.type, 'btn__body--'))}">
        ${__escape(state.body)}
    </span>
    ${ state.icon ? `<span class="btn__icon ${__escape(_tools_modifiers_js__WEBPACK_IMPORTED_MODULE_0___default()(state.type, 'btn__icon--'))}">
            ${__escape(state.icon)}
        </span>` : `${ state.iconUrl ? `<img class="btn__icon btn__icon--image ${__escape(_tools_modifiers_js__WEBPACK_IMPORTED_MODULE_0___default()(state.type, 'btn__icon--'))}" src="${__escape({iconUrl: state.iconUrl})}" alt="">` : `` }` }
</button>`;
};
