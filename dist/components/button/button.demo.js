...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _button_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./button.html */ "../../_src/components/button/button.html");
...
Button_demo._render = function(__result, state, options) {
    ...
    `, header: () => `<div slot="header">
        ${_button_html__WEBPACK_IMPORTED_MODULE_0__["default"]._render(__result, {}, { store: options.store })}
        ${_button_html__WEBPACK_IMPORTED_MODULE_0__["default"]._render(__result, {type: ['wide'], body: "Wide"}, { store: options.store })}
    </div>
    `, variants: () => `<div slot="variants">
        ${ state.widths.map((buttonType) => `<div class="button-holder">
            ${_button_html__WEBPACK_IMPORTED_MODULE_0__["default"]._render(__result, {type: buttonType, body: _tools_title_case_js__WEBPACK_IMPORTED_MODULE_2___default()(buttonType)}, { store: options.store })}
        </div>`).join("")}
    </div>
...
Button_demo.renderCss = function() {
	...
	addComponent(_button_html__WEBPACK_IMPORTED_MODULE_0__["default"]);
